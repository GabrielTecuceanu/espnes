...
const mapintf_t* mappers[] = {
    &map0_intf,   &map1_intf,  &map2_intf,  &map3_intf,  &map4_intf,  &map5_intf,   &map7_intf,
    &map8_intf,   &map9_intf,  &map11_intf, &map15_intf, &map16_intf, &map18_intf,  &map19_intf,
    &map21_intf,  &map22_intf, &map23_intf, &map24_intf, &map25_intf, &map32_intf,  &map33_intf,
    &map34_intf,  &map40_intf, &map41_intf, &map42_intf, &map46_intf, &map50_intf,  &map64_intf,
    &map65_intf,  &map66_intf, &map70_intf, &map73_intf, &map75_intf, &map78_intf,  &map79_intf,
    &map85_intf,  &map87_intf, &map93_intf, &map94_intf, &map99_intf, &map160_intf, &map229_intf,
    &map231_intf, NULL};
